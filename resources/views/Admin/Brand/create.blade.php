...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <!-- ../assets/css/soft-ui-dashboard.css?v=1.1.0" -->
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          ...
          <a class="nav-link  {{ request()->routeIs('ds') ? 'active' : '' }}" href="{{ route('ds') }}">
        ...
        <li class="nav-item">
          ...
          <a class="nav-link  {{ request()->routeIs('backends.create') ? 'active' : '' }}" href="{{ route('backends.create') }}">
        ...
        <li class="nav-item">
          ...
          <!-- <a class="nav-link"> -->
          <a class="nav-link  {{ request()->routeIs('backends.Brand.create') ? 'active' : '' }}" href="{{ route('backends.Brand.create') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>shop </title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/billing.html">
            ...
            <span class="nav-link-text ms-1">INSTOCK PRODUCT</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/virtual-reality.html">
            ...
            <span class="nav-link-text ms-1">OUT STOCK</span>
          </a>
        </li>
          <li class="nav-item">
          <a class="nav-link  " href="../pages/profile.html">
            ...
            <span class="nav-link-text ms-1">User Order</span>
          </a>
        </li>
...
<section class="section">
  <div class="row">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <!-- General Form Elements -->
            ...
            <form  action="{{route('backends.Brand.store')}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="mb-3">
        <label for="name" class="form-label">BrandName</label>

        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="namebrand" required value="{{ old('name') }}">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-12">
            <input class="form-control @error('filePicUploade') is-invalid @enderror" type="file" name="BrandImage">
        </div>
    </div>
