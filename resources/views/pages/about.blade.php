        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="about__pic">
                    <img src="{{ asset('theme/img/about/about-us.jpg') }}" alt="">
                </div>
            </div>
        </div>
        <div class="row">
...
<section class="testimonial">
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="testimonial__text">
                    ...
                    <div class="testimonial__author">
                        <div class="testimonial__author__pic">
                            <img src="{{ asset('theme/img/about/testimonial-author.jpg') }}" alt="">
                        </div>
            ...
            <div class="col-lg-6 p-0">
                <div class="testimonial__pic set-bg" data-setbg="{{ asset('theme/img/about/testimonial-pic.jpg') }}"></div>
            </div>
        </div>
    </div>
</section>
